...
# Adapated from https://github.com/divelab/DIG/blob/dig-stable/dig/threedgraph/method/spherenet/spherenet.py
...
def xyz_to_dat(pos, edge_index, num_nodes, use_torsion=False, device=None):
    """
    ...
    Args:
        ...
        use_torsion: If set to :obj:`True`, will return distance, angle and torsion, otherwise only return distance
        and angle (also retrun some useful index). (default: :obj:`False`)
    """
    j, i = edge_index  # j->i
...
class SphereNet(torch.nn.Module):
    ...
    def forward(self, batch_data):
        ...
        num_nodes = z.size(0)
        dist, angle, torsion, i, j, idx_kj, idx_ji = xyz_to_dat(pos, edge_index, num_nodes, use_torsion=True, device=z.device)
